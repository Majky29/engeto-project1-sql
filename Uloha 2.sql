...
WHERE food_category_code = '111301' 
	AND food_price_measured_quarter = ( -- povodne som chcel dat iba food_price_measured_quarter = payroll_quarter avsak TO mi nezobrazovalo spravne veci, preto som TO musel vymsliet inak. Tento princip som pouzil pri vsetkych selectoch v tejto ulohe
...
WHERE food_category_code = '114201'
	AND food_price_measured_quarter = (
	SELECT food_price_measured_quarter
	FROM t_mario_soldan_project_SQL_primary_final
	WHERE food_category_code = '114201'
	ORDER BY price_measured_from ASC
